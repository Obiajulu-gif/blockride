...
const Sidebar = () => {
	...
	return (
		<motion.div
			className="bg-gray-900 text-white h-screen p-4 flex flex-col justify-between fixed z-50 shadow-lg"
		...
		>
			...
			<div>
				<Link href="/">
					<motion.h2
						className={`text-2xl font-bold text-orange-500 transition-opacity duration-300 ${
