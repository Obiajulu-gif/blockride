          ...
          <div className="space-y-4">
            ...
            >
              <div className="flex justify-between items-center">
                <h3 className="text-lg">How does BlockRide ensure secure transactions?</h3>
                <FaPlus
                  className={`transition-transform ${
                    openFAQ === 1 ? "rotate-45 text-orange-500" : "text-orange-500"
                  }`}
                />
              </div>
              {openFAQ === 1 && (
            ...
            >
              <div className="flex justify-between items-center">
                <h3 className="text-lg">Can anyone list their vehicle on BlockRide?</h3>
                <FaPlus
                  className={`transition-transform ${
                    openFAQ === 2 ? "rotate-45 text-orange-500" : "text-orange-500"
                  }`}
                />
              </div>
              {openFAQ === 2 && (
            ...
            >
              <div className="flex justify-between items-center">
                <h3 className="text-lg">What are the benefits of ride-sharing?</h3>
                <FaPlus
                  className={`transition-transform ${
                    openFAQ === 3 ? "rotate-45 text-orange-500" : "text-orange-500"
                  }`}
                />
              </div>
              {openFAQ === 3 && (
